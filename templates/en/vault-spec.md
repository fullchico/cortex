...
> Vault blueprint. The CLI uses this file to scaffold notes.
> Edit freely to customize your project structure.
...
### context-template
> Template used when creating new contexts with "cortex context <name>"
...
### timeline-template
> Template used when creating timeline notes
